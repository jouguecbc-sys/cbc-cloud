              ...
              return (
                ...
                >
                  ...
                  <div className={`w-full md:w-40 flex flex-col items-center justify-center p-4 border-b md:border-b-0 md:border-r ${styles.divider} ${styles.overlay} shrink-0`}>
                     ...
                     <button
                       onClick={() => onPriorityChange(item.id, priority)}
                       className={`px-2 py-1 rounded text-[10px] uppercase tracking-wider border mb-2 w-full text-center transition-all active:scale-95 shadow-sm hover:shadow-md cursor-pointer ${prioStyle}`}
