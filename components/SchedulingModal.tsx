            ...
            <div className="space-y-4 bg-white p-4 rounded-xl border border-gray-100 shadow-sm relative">
                    ...
                    <ul className="absolute z-10 w-full bg-white border border-gray-200 rounded-lg shadow-xl max-h-48 overflow-y-auto mt-1">
                        {filteredClients.map((c, idx) => (
                            <li 
                                ...
                                className="px-4 py-2 hover:bg-green-50 cursor-pointer text-sm text-gray-700 border-b border-gray-50 last:border-0 flex justify-between"
                            >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 outline-none shadow-sm transition-colors cursor-pointer ${getPriorityColorClass(formData.priority)}`}
